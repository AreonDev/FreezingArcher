...
namespace Henge3D
{
	...
	public struct AlignedBox
	{
		...
		{
            Vector3.ComponentMin(ref Minimum, ref p, out Minimum);
            Vector3.ComponentMax(ref Maximum, ref p, out Maximum);
		}
		...
		public static void Fit(IList<Vector3> vertices, out AlignedBox aabb)
		{
			...
			{
				var v = vertices[i];
                Vector3.ComponentMin(ref v, ref aabb.Minimum, out aabb.Minimum);
                Vector3.ComponentMax(ref v, ref aabb.Maximum, out aabb.Maximum);
			}
		}
		...
		{
			Vector3.ComponentMin(ref aabb1.Minimum, ref aabb2.Minimum, out output.Minimum);
			Vector3.ComponentMax(ref aabb1.Maximum, ref aabb2.Maximum, out output.Maximum);
		}
