...
namespace Henge3D
{
    ...
    public struct Sphere
    {
        ...
        public bool Intersect (ref Segment segment, out float scalar, out Vector3 p)
        {
            ...
            Vector3 s, d;
            Vector3.Subtract (ref Center, ref segment.P1, out s);
            Vector3.Subtract (ref segment.P2, ref segment.P1, out d);
        ...
        /// <param name="sphere">Returns the sphere containing all points.</param>
