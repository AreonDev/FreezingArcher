...
namespace Henge3D
{
    ...
    public struct Transform
    {
        ...
        public void Invert (out Transform inverted)
        {
            ...
            Quaternion.Invert (ref Orientation, out inverted.Orientation);
            Vector3.Multiply (ref Position, -1, out inverted.Position);
                              ...
                              out Matrix output)
        {
            ...
            Matrix.Mult (ref output, ref rotation, out output);
                                     ...
                                     out Matrix worldInverse)
        {
            ...
            Matrix.Mult (ref worldInverse, ref rotationInv, out worldInverse);
            Matrix.CreateScale (scaleInv, out tmp);
            Matrix.Mult (ref worldInverse, ref tmp, out worldInverse);
        }
    }
}
