...
namespace Henge3D.Physics
{
	...
	public struct MassProperties
	{
		...
		public static MassProperties FromTriMesh(float density, Vector3[] vertices, int[] indices, out Vector3 centerOfMass)
		{
			...
			Matrix.Mult(ref inertia, density, out inertia);
		...
		public static MassProperties FromCapsule(float density, Vector3 p1, Vector3 p2, float radius, out Vector3 center)
		{
			...
			Matrix.Mult(ref orientation, ref i, out i);
			Matrix.Mult(ref i, ref inv, out i);
			i.M44 = 0f;
		...
		internal static void Transform(ref MassProperties mass, ref Transform transform, out MassProperties output)
		{
			...
			Matrix.Mult(ref orientationInv, ref mass.Inertia, out output.Inertia);
			Matrix.Mult(ref output.Inertia, ref orientation, out output.Inertia);
			Matrix.Mult(ref orientationInv, ref mass.InertiaInverse, out output.InertiaInverse);
			Matrix.Mult(ref output.InertiaInverse, ref orientation, out output.InertiaInverse);
		}
