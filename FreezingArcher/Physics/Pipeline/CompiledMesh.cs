...
namespace Henge3D.Pipeline
{
    ...
    internal abstract class TriangleFunctor : TreeFunctor<Triangle, ushort>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Henge3D.Pipeline.TriangleFunctor"/> class.
        /// </summary>
    ...
    public class CompiledMesh : CompiledPart
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Henge3D.Pipeline.CompiledMesh"/> class.
        /// </summary>
        public CompiledMesh ()
        {
        }
        ...
        private void BuildOctree ()
        {
            ...
            _nodes = (from node in tempNodes
                        select new Node () {
                Children = (from i in node.Children
                                  where i > 0
                                  select (ushort)i).ToArray (),
                Triangles = (from i in node.Triangles
                                   select (ushort)i).ToArray (),
        ...
        private void CreateChildBox (ref AlignedBox box, int sector, out AlignedBox output)
        {
            ...
            case 1:
                ...
                break;
            case 2:
                p = new Vector3 (1f, 1f, 0f);
                break;
            case 3:
                p = new Vector3 (1f, 0f, 0f);
                break;
            default:
                throw new Exception ("Internal error: invalid bounding box section.");
            }
            if (sector > 3)
                p.Z = 1f;
