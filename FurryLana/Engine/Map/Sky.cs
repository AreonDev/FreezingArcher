...
namespace FurryLana.Engine.Map
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FurryLana.Engine.Map.Sky"/> class.
        /// </summary>
        public Sky ()
        {
        }
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="FurryLana.Engine.Map.Sky"/> is loaded.
        /// </summary>
